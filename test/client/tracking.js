...
describe(`tracking cases`, () => {
    ...
    it('should throw an Error', async () => {
        ...
        // $FlowFixMe
        const { getSDKInitTime: getSDKInitTimeA } = await import('../../src/tracking?q=1');
        /* eslint-enable */
        ...
        try {
            ...
            if (err.message !== errorMessage) {
                throw new Error(`should  get a valid Error message, instead got: ${ err.message }`);
            }
        }
    });
    ...
    it('should find a saved Date instance', () => {
        try {
            ...
            throw new Error(`should  get a valid Date instance, instead got an error: ${ err.message }`);
        }
    });
